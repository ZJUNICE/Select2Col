...
class IntermediateFusionDataset(basedataset.BaseDataset):
    ...
    """
    count = 0
    def __init__(self, params, visualize, train=True, uni_time_delay = -1, model_type='Select2Col', dataset_split_id=-1):
        super(IntermediateFusionDataset, self). \
            __init__(params, visualize, train, dataset_split_id)
        ...
        self.post_processor = post_processor.build_postprocessor(
            params['postprocess'],
            train)
        self.uni_time_delay = uni_time_delay
        self.model_type = model_type
    def __getitem__(self, idx):
        base_data_dict = self.retrieve_base_data(idx,
                                                 cur_ego_pose_flag=self.cur_ego_pose_flag, uni_time_delay=self.uni_time_delay,model_type=self.model_type)
        ...
        for cav_id, selected_cav_base in base_data_dict.items():
                ...
                math.sqrt((selected_cav_base['params']['lidar_pose'][0] -
                           ego_lidar_pose[0]) ** 2 + (
                                  selected_cav_base['params'][
                                      ...
                                      1]) ** 2)
            # print("opencood.data_utils.datasets.COM_RANGE:",opencood.data_utils.datasets.COM_RANGE)
            # print('cav_id,distance:',cav_id,distance)
            ...
            processed_features.append(
                selected_cav_processed['processed_features'])  ## lidar after transformed
        ...
        IntermediateFusionDataset.count += len(object_stack)
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose):
        ...
        # print('object_ids:',object_ids,type(object_ids))
