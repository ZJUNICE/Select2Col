...
def main():
    ...
    opencood_train_dataset = build_dataset(hypes, visualize=False, train=True, uni_time_delay=-1, model_type=model_type)
    opencood_validate_dataset = build_dataset(hypes, visualize=False, train=False,uni_time_delay=-1, model_type=model_type)
